<template>
	<div class="carousel">
		<img class="carousel__image" :src="photos[selectedPhotoIndex]" v-if="showPhoto" />

		<div class="carousel__bullets">
			<div
				@click="setCarouselAction(() => (selectedPhotoIndex = index))"
		...
		<v-icon size="45" class="carousel__chevron-left" @click="getPreviusPhoto"> mdi-chevron-left </v-icon>
		<v-icon size="45" class="carousel__chevron-right" @click="getNextPhoto"> mdi-chevron-right </v-icon>
	</div>
</template>
